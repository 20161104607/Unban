...
<frame src="statics/jsp/left_doctor.jsp" name="leftmenu" id="mainFrame" title="mainFrame">
<frame src="statics/jsp/main_doctor
.jsp" name="main" scrolling="yes" noresize="noresize" id="rightFrame" title="rightFrame"></frameset></frameset>
<noframes></noframes>
</html>